...
- Set Plattform specific settings and install latest Hypervisor Tools (vSphere, PowerVM, Cloud, Bare-Metal etc.) for Example: I/O Scheduler, Kernel oder mutipath Settings
